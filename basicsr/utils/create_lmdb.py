...
def create_lmdb_for_restored_gopro():
#     folder_path = './datasets/GoPro/restored_width32_test/input'
#     lmdb_path = './datasets/GoPro/restored_width32_test/input.lmdb'

#     folder_path = './datasets/GoPro/restored_width64_test/input'
#     lmdb_path = './datasets/GoPro/restored_width64_test/input.lmdb'

#     folder_path = './datasets/GoPro/restored_width32_test/input_one'
#     lmdb_path = './datasets/GoPro/restored_width32_test/input_one.lmdb'

#     folder_path = './datasets/GoPro/restored_width64_test/input_one'
#     lmdb_path = './datasets/GoPro/restored_width64_test/input_one.lmdb'
    
    folder_path = './datasets/GoPro/restored_width64_test/input3'
    lmdb_path = './datasets/GoPro/restored_width64_test/input3.lmdb'
    
#     folder_path = './datasets/GoPro/restored_width32_train/input'
#     lmdb_path = './datasets/GoPro/restored_width32_train/input.lmdb'
    
#     folder_path = './datasets/GoPro/restored_width64_train/input'
#     lmdb_path = './datasets/GoPro/restored_width64_train/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

#     folder_path = './datasets/GoPro/restored_width32_test/target'
#     lmdb_path = './datasets/GoPro/restored_width32_test/target.lmdb'
    
#     folder_path = './datasets/GoPro/restored_width64_test/target'
#     lmdb_path = './datasets/GoPro/restored_width64_test/target.lmdb'

#     folder_path = './datasets/GoPro/restored_width32_test/target_one'
#     lmdb_path = './datasets/GoPro/restored_width32_test/target_one.lmdb'
    
#     folder_path = './datasets/GoPro/restored_width64_test/target_one'
#     lmdb_path = './datasets/GoPro/restored_width64_test/target_one.lmdb'
    
    folder_path = './datasets/GoPro/restored_width64_test/target3'
    lmdb_path = './datasets/GoPro/restored_width64_test/target3.lmdb'
    
#     folder_path = './datasets/GoPro/restored_width32_train/target'
#     lmdb_path = './datasets/GoPro/restored_width32_train/target.lmdb'
    
#     folder_path = './datasets/GoPro/restored_width64_train/target'
#     lmdb_path = './datasets/GoPro/restored_width64_train/target.lmdb'
